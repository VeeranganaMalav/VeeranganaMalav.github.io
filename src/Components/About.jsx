...
const About = () => {
  return (
    <div id="about" className="intro-section about section">
      <div className="illustration">
        ...
        <div id="user-detail-intro" className="about-me">
            ...
            <div className="button">
                <a href="https://drive.google.com/uc?id=1pXXENn_m-X9xgEXNGgnFWM7DI7zPTi2N&export=download" id="resume-link-2" target="_blank" rel="noreferrer">
